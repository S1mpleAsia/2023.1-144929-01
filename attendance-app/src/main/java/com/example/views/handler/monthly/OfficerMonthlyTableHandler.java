...
public class OfficerMonthlyTableHandler extends MonthlyHandler implements Initializable {
    @FXML
    ...
    void handleBackScreen(MouseEvent event) throws IOException {
        navigate(Constraints.OFFICER_HOME_SCREEN_PATH, Constraints.OFFICER_HOME_STYLESHEET_PATH, event);
    }
